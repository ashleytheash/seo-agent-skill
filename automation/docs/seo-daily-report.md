...
> **Bundle layout:** Script [`automation/scripts/seo-daily-report.ts`](../scripts/seo-daily-report.ts), workflow [`automation/workflows/seo-daily-report.yml`](../workflows/seo-daily-report.yml). Adopt via [`automation/README.md`](../README.md).
...
- Workflow: `automation/workflows/seo-daily-report.yml`
- Script: `automation/scripts/seo-daily-report.ts`
...
```bash
pnpm --filter @open-design/landing-page exec tsx apps/landing-page/scripts/seo-daily-report.ts --dry-run
```
